...
\begin{itemize}
  ...
  \item \textbf{블라인드 영점 외삽
        ...
        확립한다. 윤곽 적분 모노드로미 측정에서 4개 $L$-함수에 걸쳐 완벽 분리를 달성한다:
        ...
        \textbf{총 85 TP / 144 FP, degree 1--2, rank 0--1, 예외 0건.}
        이중 기준($\kappa + \mathrm{mono}$)이 정밀도 $100\%$를 보장한다.
        \textcolor{ForestGreen}{[2026-04-29 확인; 4개 $L$-함수, degree 1--2, rank 0--1; 수치 검증, 증명 아님]}
