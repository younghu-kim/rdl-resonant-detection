...
PARI/GP \texttt{lfun} 기반 블라인드 예측을 3곡선에 추가 수행:
11a1 (rank~0, $F_1 = 1.000$, 36/36~TP),
389a1 (rank~2, $F_1 = 1.000$, 63/63~TP),
5077a1 (rank~3, $F_1 = 0.994$, 82/83~TP).
5곡선 GL(2) 총합: $181/182 = 99.5\%$ 검출, 거짓 양성 0.
\emph{$\xi$-다발 프레임워크가 해석적 rank에 무관하게 GL(2) $L$-함수 영점을 검출함을 시사하는 수치 증거이다.}
