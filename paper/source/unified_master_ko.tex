...
\midrule
7 & 5 & 760 & 1.004 & 0.000000 & 100\% & $12.1$--$50.1\times$ \\
8 & 2+1${}^\ddagger$ & 423 & 1.004 & 0.000000 & 100\% & $60.2$--$194.3\times$ \\
\textbf{11} & \textbf{9} & \textbf{1367} & \textbf{1.004} & \textbf{0.000000} & \textbf{100\%} & $\mathbf{6.3}$--$\mathbf{1023\times}$ \\
\midrule
\multicolumn{2}{l}{\textbf{누적 ($q = 3$--$11$)}} & \textbf{$\sim$2590} & & & & \\
\bottomrule
\end{tabular}
\end{center}
...
$q{=}11$의 4개 켤레 쌍에서 $E$-비율 비대칭의 연속적 스펙트럼 발견:
