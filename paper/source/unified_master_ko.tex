...
\begin{itemize}
  ...
  \item \textbf{블라인드 영점 외삽
        ...
        \textbf{총 205 TP / 395 FP, 10개 $L$-함수, degree 1--5, weight 1--12, rank 0--1, 실수·복소 지표, Dedekind 제타 포함, 예외 0건.}
        이중 기준($\kappa + \mathrm{mono}$)이 정밀도 $100\%$를 보장한다.
        임계선 커버리지: $\{\tfrac{1}{2}, 1, \tfrac{3}{2}, 2, \tfrac{5}{2}, 6\}$ (6종).
        구성 경로: GL(1) Dirichlet, GL(2) EC/Maass/$\Delta$, GL(3)--GL(5) sym$^k$, Dedekind zeta (7종).
        \textcolor{ForestGreen}{[2026-04-30 확인; 10개 $L$-함수, degree 1--5; 수치 검증, 증명 아님]}
...
10개 원시 $L$-함수, degree $\{1,2,3,4,5\}$, weight $\{1,2,3,12\}$,
7종 구성 경로(Riemann $\zeta$, Dirichlet, 타원 곡선, Ramanujan $\Delta$,
sym$^k$, Dedekind $\zeta_K$ ($\mathrm{Gal}\cong S_3$)),
6종 임계선 $\{\tfrac12,1,\tfrac32,2,\tfrac52,6\}$,
\textbf{205 TP / 395 FP, 이중 기준 통과율 100\%,
