...
${}^{\dagger}$~직접 $\sigma$-비교: $\kappa(\sigma{=}0.5)/\kappa(\sigma{=}0.3)$,
$\delta{=}0.03$ ($q=3,4,5$의 근접/원격 방법과 다름).}

\noindent
$q=3,4,5$ 3개 지표 38개 영점 전체에서 모노드로미 $\Delta\arg\Lambda = \pm\pi$ (편차 $< 10^{-4}$);
$\chi\bmod 7$ ($q=7$)에서는 136개 영점 모두 편차 $0.000000\pm 0.000000$으로 동일 조건 충족 (로그 공간 계산).
