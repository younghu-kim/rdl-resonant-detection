...
\begin{itemize}
  ...
  \item \textbf{블라인드 영점 외삽
        ...
        20 TP / 12 FP; KS $p = 8.9 \times 10^{-9}$; degree~3 첫 전용 검증;
        $\Gamma$-벡터 $[0,0,1]$; 영점 밀도로 FP 12개, 모두 mono=0).
        \textbf{총 145 TP / 216 FP, degree 1--3, weight 1--12, rank 0--1, 실수 및 복소 지표, 예외 0건.}
        이중 기준($\kappa + \mathrm{mono}$)이 정밀도 $100\%$를 보장한다.
        \textcolor{ForestGreen}{[2026-04-29 확인; 7개 $L$-함수, degree 1--3, weight 1--12, rank 0--1; 수치 검증, 증명 아님]}
