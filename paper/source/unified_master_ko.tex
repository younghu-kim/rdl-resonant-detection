...
\begin{itemize}
  ...
  \item \textbf{블라인드 영점 외삽
        ...
        GL(2) Ramanujan $\Delta$ ($N=1$, weight~12, $\varepsilon=+1$, $\sigma=6$;
        20 TP / 30 FP; KS $p = 4.2 \times 10^{-14}$; weight~12 첫 전용 검증).
        모든 경우 TP $|\mathrm{mono}|/\pi = 2.000 \pm 0.000$,
        FP $|\mathrm{mono}|/\pi = 0.000 \pm 0.000$.
        \textbf{총 125 TP / 204 FP, degree 1--2, weight 1--12, rank 0--1, 실수 및 복소 지표, 예외 0건.}
        이중 기준($\kappa + \mathrm{mono}$)이 정밀도 $100\%$를 보장한다.
        \textcolor{ForestGreen}{[2026-04-29 확인; 6개 $L$-함수, degree 1--2, weight 1--12, rank 0--1, 실수+복소 지표; 수치 검증, 증명 아님]}
