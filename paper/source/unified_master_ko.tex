...
\begin{itemize}
  ...
  \item \textbf{블라인드 영점 외삽
        ...
        확립한다. 윤곽 적분 모노드로미 측정($t\in[14,300]$,
        25 TP / 60 FP)에서 TP $|\mathrm{mono}|/\pi = 2.000 \pm 0.000$,
        FP $|\mathrm{mono}|/\pi = 0.000 \pm 0.000$
        (KS $p = 4.2 \times 10^{-14}$)으로 완벽 분리를 달성하여,
        이중 기준($\kappa + \mathrm{mono}$)이 정밀도 $100\%$를 보장한다.
        \textcolor{ForestGreen}{[2026-04-28 확인; 수치 검증, 증명 아님]}
