...
\begin{itemize}
  ...
  \item \textbf{블라인드 영점 외삽
        ...
        11a1의 sym$^k$ 타워: $k=1$ (degree~2), $k=2$ (degree~3), $k=3$ (degree~4) 전부 완벽 분리).
        \textbf{총 165 TP / 264 FP, degree 1--4, weight 1--12, rank 0--1, 실수 및 복소 지표, 예외 0건.}
        이중 기준($\kappa + \mathrm{mono}$)이 정밀도 $100\%$를 보장한다.
        임계선 커버리지: $\{\tfrac{1}{2}, 1, \tfrac{3}{2}, 2, 6\}$ (5종).
        \textcolor{ForestGreen}{[2026-04-30 확인; 8개 $L$-함수, degree 1--4, weight 1--12, rank 0--1; 수치 검증, 증명 아님]}
