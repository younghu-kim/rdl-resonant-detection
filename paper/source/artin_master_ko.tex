...
$\sigma$-방향에서 확인하고 $S_{3}$를 제2논문의 13개 $L$-함수 비교표
...
본 논문은 $\xi$-다발 프레임워크를 세 방향으로 확장한다.
...
기울기 $2.0000\pm0.0000$ ($R^{2}=1.000000$)을 산출하여,
$S_{3}$를 제2논문의 보편 13개 $L$-함수 비교표 (차수 1--6, 모두 기울기~$\approx 2.0$)와
완전히 일치시킨다.
두 방향은 상보적이다: $\sigma$-방향 기울기~$=+2$는 Selberg 류 전반에 걸쳐 보편적이며
($c_{1}=0$의 귀결), $t$-방향 기울기~$\approx{-1}$는 각 $L$-함수 고유의
해석적 구조를 반영한다.
셋째, 임계선 외 곡률 판별자 $c_{1}\cdot\abs{\sigma_{0}-\tfrac{1}{2}} \to 1$을
