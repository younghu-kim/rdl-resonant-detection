...
($p = 9.7 \times 10^{-17}$).
GL(2) elliptic curve 11a1 ($N=11$, rank~0): mono$/\pi = 2.000 \pm 0.000$
...
Combined across GL(1)--GL(2): \textbf{99~TP, 180~FP}, zero exceptions.
...
\begin{enumerate}
  ...
  \item \textbf{GL(2) EC 11a1 monodromy at $\sigma = 1$ (weight-2 critical line).}
        ...
        Combined with results~\#43 and \#43b:
        \textbf{65~TP / 120~FP across 3~$L$-functions
        (degree 1--2), zero exceptions.}
