...
\begin{itemize}
  ...
  \item \textbf{GL(3)--GL(5)}: dedicated monodromy tests on
    the sym$^k$(11a1) tower ($k=2,3,4$; degree $d=3,4,5$;
    $\sigma_c = 1.5, 2, 2.5$ respectively):
    each yields 20~TP / 30~FP with mono$/\pi = 2.000 \pm 0.000$
    (TP) and $0.000 \pm 0.000$ (FP), KS $p \leq 7.1 \times 10^{-14}$,
    dual precision 100\%.
    The sym$^k$ tower provides the strongest universality evidence:
    \emph{identical} monodromy quantisation across five degrees,
    six critical lines, and four distinct $\Gamma$-factor structures.
\end{itemize}
...
GL(2) Ramanujan~$\Delta$ ($N=1$, weight~12, $\sigma_c=6$):
mono$/\pi = 2.000 \pm 0.000$ for 20~TP, $0.000 \pm 0.000$ for 30~FP
(KS $p = 4.2 \times 10^{-14}$; first weight$\geq 3$ dedicated).
GL(3) sym$^2$(11a1) ($N=121$, degree~3, $\sigma_c=1.5$):
mono$/\pi = 2.000 \pm 0.000$ for 20~TP, $0.000 \pm 0.000$ for 30~FP
(KS $p = 7.1 \times 10^{-14}$; first degree-3 dedicated).
GL(4) sym$^3$(11a1) ($N=1331$, degree~4, $\sigma_c=2$):
mono$/\pi = 2.000 \pm 0.000$ for 20~TP, $0.000 \pm 0.000$ for 30~FP
(KS $p = 4.2 \times 10^{-14}$; first degree-4 dedicated).
GL(5) sym$^4$(11a1) ($N=14641$, degree~5, $\sigma_c=2.5$):
mono$/\pi = 2.000 \pm 0.000$ for 20~TP, $0.000 \pm 0.000$ for 30~FP
(KS $p = 4.2 \times 10^{-14}$; first degree-5 dedicated).
Combined across GL(1)--GL(5): \textbf{185~TP (dedicated) + 34~TP (cross-rank) = 219~TP},
\textbf{294~FP (dedicated) + 60~FP (cross-rank) = 354~FP},
9~$L$-functions, degree 1--5, weight 1--12, rank 0--1,
6~distinct critical lines
$\{\tfrac{1}{2}, 1, \tfrac{3}{2}, 2, \tfrac{5}{2}, 6\}$,
zero exceptions.
...
\begin{enumerate}
  ...
  \item \textbf{GL(5) sym$^4$(11a1) dedicated monodromy at $\sigma_c = 2.5$ (degree~5).}
        ...
        Combined dedicated results (\#43, \#43b--\#43i):
        \textbf{185~TP / 294~FP across 9~$L$-functions
