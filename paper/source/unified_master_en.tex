...
43g & GL(3) sym$^2$(11a1) monodromy ($\sigma_c{=}1.5$, $d{=}3$) & \textbf{E} & 20 TP mono$/\pi{=}2.000{\pm}0$; 12 FP mono$/\pi{=}0.000$; KS $p{=}8.9{\times}10^{-9}$; dual prec.\ 100\%; first degree-3 dedicated; $\kappa$ TP${\sim}10^4$, FP${\sim}1$--$7$ & GL(3) \\
...
\begin{enumerate}
  ...
  \item \textbf{GL(3) sym$^2$(11a1) dedicated monodromy at $\sigma_c = 1.5$ (degree~3).}
        ...
        \textbf{145~TP / 216~FP across 7~$L$-functions
