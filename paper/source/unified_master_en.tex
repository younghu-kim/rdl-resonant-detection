...
\begin{itemize}
  ...
  \item \textbf{GL(3)}: $L(s, \mathrm{sym}^2(11\mathrm{a}1))$
    (degree~3, conductor~121, weight~3, $\sigma_c = 1.5$,
    $\Gamma$-vector $[0,0,1]$):
    20~TP / 30~FP, KS $p = 4.2 \times 10^{-14}$; perfect separation
    extends to degree~3 with a qualitatively different $\Gamma$-factor
    structure.
\end{itemize}
...
GL(2) Ramanujan~$\Delta$ ($N=1$, weight~12, $\varepsilon=+1$, $\sigma_c = 6$):
mono$/\pi = 2.000 \pm 0.000$ for 20~TP, $0.000 \pm 0.000$ for 30~FP
(KS $p = 4.2 \times 10^{-14}$; first $w \geq 3$ dedicated; critical line $\sigma_c = 6$).
GL(3) $L(s, \mathrm{sym}^2(11\mathrm{a}1))$ ($d=3$, conductor~121, $\sigma_c = 1.5$):
mono$/\pi = 2.000 \pm 0.000$ for 20~TP, $0.000 \pm 0.000$ for 30~FP
(KS $p = 4.2 \times 10^{-14}$; first degree-3 dedicated;
$\Gamma$-vector $[0,0,1]$).
Combined across GL(1)--GL(3): \textbf{179~TP, 294~FP}, zero exceptions.
...
43g & GL(3) sym$^2$(11a1) monodromy ($\sigma_c{=}1.5$, $d{=}3$) & \textbf{E} & 20 TP mono$/\pi{=}2.000{\pm}0$; 30 FP mono$/\pi{=}0.000$; KS $p{=}4.2{\times}10^{-14}$; dual prec.\ 100\%; first degree-3 dedicated; $\kappa$ TP${\sim}10^4$, FP${\sim}0.01$--$45$ & GL(3) \\
...
\begin{enumerate}
  ...
  \item \textbf{GL(3) sym$^2$(11a1) dedicated monodromy at $\sigma_c = 1.5$ (degree~3).}
        ...
        (KS $p = 4.2 \times 10^{-14}$; dual precision 100\%).
        Curvature: $\kappa_{\mathrm{TP}} \sim 10^{4}$,
        $\kappa_{\mathrm{FP}} \sim 0.01$--$45$ (3 orders of magnitude gap).
        ...
        ($\Gamma$-vector $[0,0,1]$: $\Gamma_{\mathbb{R}}(s)^2 \Gamma_{\mathbb{R}}(s{+}1)$).
