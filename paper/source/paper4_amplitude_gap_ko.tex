...
\begin{enumerate}
  ...
  \item \textbf{$2H_1/A$의 차수 스케일링.}\;
        비율이 $0.87$(GL(1))에서 감소하여 $d \ge 4$에서 ${\sim}0.66$으로 포화한다.
        GUE 값은 $0.78$이므로, $0.66$으로의 포화는 랜덤 행렬 보편이 아닌
        산술적 내용을 반영한다. 정확한 값과 감쇠 메커니즘이
        $L$-함수의 차수로부터 예측될 수 있는가?
