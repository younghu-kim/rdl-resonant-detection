...
\begin{table}[h]
\centering
\caption{통일 비교: 차수 1--6에 걸친 $\rho_{\mathrm{S}}(A_L, g_{\min})$과
GUE 기준선.}
\label{tab:unified}
\begin{tabular}{llrrrl}
\toprule
\textbf{$L$-함수} & $d$ & $n$ &
$\rho_{\mathrm{S}}$ & $p$ & $2H_1/A_L$ \\
\midrule
$\zeta(s)$ & 1 & 337 & $-0.437$ & $3.7 \times 10^{-17}$ & $0.666$ \\
$L(s,E_{11\mathrm{a}1})$ & 2 & 90 & $-0.423$ & $3.3 \times 10^{-5}$ & $0.652$ \\
$L(s,E_{37\mathrm{a}1})$ & 2 & 110 & $-0.525$ & $3.8 \times 10^{-9}$ & $0.675$ \\
$L(s,\mathrm{sym}^2 E_{11})$ & 3 & 96 & $-0.422$ & $1.9 \times 10^{-5}$ & $0.748$ \\
$L(s,\mathrm{sym}^2 E_{37})$ & 3 & 48 & $-0.492$ & $3.8 \times 10^{-4}$ & $0.678$ \\
$L(s,\mathrm{sym}^3 E_{11})$ & 4 & 101 & $-0.520$ & $2.5 \times 10^{-8}$ & $0.661$ \\
$L(s,\mathrm{sym}^3 E_{37})$ & 4 & 131 & $-0.514$ & $3.5 \times 10^{-10}$ & $0.676$ \\
$L(s,\mathrm{sym}^4 E_{11})$ & 5 & 132 & $-0.485$ & $3.7 \times 10^{-9}$ & $0.661$ \\
$L(s,\mathrm{sym}^5 E_{11})$ & 6 & 71 & $-0.423$ & $2.4 \times 10^{-4}$ & $0.657$ \\
\midrule
$\GUE(N)$ & --- & --- & $-0.857$ & $\approx 0$ & $0.778$ \\
\bottomrule
\end{tabular}
\end{table}

통일 $(A_L, g_{\min})$ 메트릭 하에서, 아홉 개의 $L$-함수 모두
$\rho_{\mathrm{S}} \in [-0.525, -0.422]$이며 체계적인 차수 의존성이 없다.
