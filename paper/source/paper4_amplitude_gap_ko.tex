...
차수~1--3의 아홉 개 $L$-함수에서
$\rho_{\mathrm{S}} = -0.891 \pm 0.015$ (범위~$0.043$)이며,
...
\begin{table}[h]
\centering
\caption{아홉 개 $L$-함수(자기쌍대 5개, 비자기쌍대 4개)에서의
...
\midrule
\multicolumn{3}{l}{자기쌍대 평균 ($n = 5$)} & & $-0.893$ & & $\varepsilon = \pm 1$ \\
\multicolumn{3}{l}{비자기쌍대 평균 ($n = 4$)} & & $-0.887$ & & $\varepsilon \in S^1$ \\
\multicolumn{3}{l}{전체 평균 ($n = 9$)} & & $-0.891$ & & \\
...
평균 Spearman 상관은 자기쌍대 가족($\varepsilon = \pm 1$)에서 $-0.893$,
비자기쌍대 가족($\varepsilon \in S^1$)에서 $-0.887$로,
차이 $0.006$은 개별 $95\%$ 신뢰구간 범위 내에 있다.
따라서 상관은 근호수에 무관하며,
