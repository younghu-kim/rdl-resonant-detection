...
\begin{enumerate}[label=(\roman*)]
  ...
  \item \textbf{방법론 보정}
        ...
        세 가지 효과를 혼합한 것이다.
        동일 방법론 하에서 잔여 산술 감쇠는
        $d = 1$에서 $\Delta\rho \approx 0.04$,
        $d = 2$에서 ${\sim}\,0.24$로,
        감쇠가 차수-의존적임을 확립한다.
\end{enumerate}
...
$W\!=\!5$에서 $0.039$, $W\!=\!300$에서 $0.014$로 단조 감소하며,
스피어만 추세 $\rho_{\mathrm{S}}(W,\delta) = -0.905$ ($p = 0.002$).
감소의 주된 원인은 원거리 영점이 추가적 산술 상관을 기여하면서
$|\rho_\zeta|$가 $0.94$에서 $0.96$으로 강화되는 것이며,
$|\rho_{\GUE}| \approx 0.97$은 $W\!=\!5$에서 이미 포화 상태이다.
이러한 \emph{산술 비국소성 시차}---$\zeta(s)$의 영점 간 상관이
GUE에 비해 공간적으로 더 느리게 감쇠하는 현상---는
$W = 300$에서의 잔여 $\Delta\rho \approx 0.04$가 내재적 산술 감쇠보다는
유한 윈도우 효과일 가능성을 시사하지만,
$W \to \infty$ 외삽은 열린 질문으로 남아 있다.
\end{remark}
...
\begin{enumerate}
  ...
  \item \textbf{산술적 감쇠 --- 수정.}\;
        동일 조건($\pm 300$ 국소, $20\%$ 트림)에서
        GUE는 $\rho_{\mathrm{S}} = -0.967$, $\zeta(s)$는 $-0.929$이다
        (\cref{rem:locality}).
        잔여 산술 감쇠는 $d = 1$에서 $\Delta\rho \approx 0.04$에 불과하며,
        GUE 전체합과 $L$-함수 국소합을 비교한 나이브 값 $0.38$보다 훨씬 작다.
...
\begin{enumerate}
  ...
  \item \textbf{차수-의존 감쇠 메커니즘.}\;
        동일 방법론($\pm 300$ 국소, $20\%$ 트림)에서
        GUE 기준선 $|\rho_{\mathrm{S}}| = 0.97$이
        $\zeta(s)$에서 $0.93$($\Delta\rho \approx 0.04$)으로,
        GL(2)에서 ${\sim}\,0.67$($\Delta\rho \approx 0.30$)로 감쇠한다.
        차수-의존 감쇠가 감마 인자 복잡성에서 유래하는지
        $d \ge 2$의 오일러 곱 구조에서 유래하는지 추적할 수 있는가?
