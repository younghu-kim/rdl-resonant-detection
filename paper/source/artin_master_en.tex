...
and $-0.993\pm0.003$ respectively, and monodromy $\pm\pi$.  These
constitute the first numerical verification of the $\xi$-bundle
...
\midrule
3 & \textbf{Artin $S_{3}$ (non-abelian)} & \textbf{2} & \textbf{P1--P4~\checkmark} \\
...
This paper extends the $\xi$-bundle framework in two directions.
...
$R^{2} > 0.9999$.  Second, we extend the off-critical curvature
...
landscape provides strong numerical evidence that the $\xi$-bundle
captures a fundamental geometric structure of $L$-function zeros.
