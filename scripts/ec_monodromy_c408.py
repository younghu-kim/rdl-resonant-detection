"""
=============================================================================
[C-408] EC L-함수 모노드로미 TP/FP 분리 검증 — 11a1 (degree 2)
=============================================================================
목표: 모노드로미 TP/FP 분리가 degree 2 (EC) L-함수에서도 성립하는지 확인.
  - GL(1): ζ(s) 25TP/60FP + L(s,χ₅) 20TP/30FP → 완벽 분리 확립 (C-403/406/407)
  - 이제 GL(2) EC L-함수에서 동일 현상 확인 (degree 확장)

방법:
  1. 11a1 EC L-함수의 영점 수집 (PARI lfunzeros)
  2. FP 후보 생성 (영점 간 중점 + 랜덤)
  3. TP/FP에서 폐곡선 모노드로미 계산 (PARI lfunlambda)
...
OUT_PATH = os.path.expanduser(
    '~/Desktop/gdl_unified/results/ec_monodromy_c408.txt'
)
...
def main():
    ...
    print("=" * 70)
    print(f"[C-408] EC L-함수 모노드로미 TP/FP 검증")
    ...
    with open(OUT_PATH, 'w') as f:
        f.write("=" * 70 + "\n")
        f.write("[C-408] EC L-함수 모노드로미 TP/FP 검증\n")
